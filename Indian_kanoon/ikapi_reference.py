"""Indian Kanoon Official API Client — Reference Copy

Source: https://github.com/sushant354/IKAPI/blob/main/python/ikapi.py
License: MIT
Retrieved: 2026-02-22

DO NOT MODIFY — this is a reference copy of the official client.
Our actual implementation lives in src/acquisition/scrapers/_indian_kanoon.py
"""
